  ...
  assistant: {
    ...
    tool: {
      ...
      titles: {
        ...
        vault_append_note: { done: 'Saved to vault', pending: 'Saving to vault', pendingAction: 'Saving' },
        vault_create_note: { done: 'Saved to vault', pending: 'Saving to vault', pendingAction: 'Saving' },
        vault_delete_note: { done: 'Deleted vault note', pending: 'Deleting vault note', pendingAction: 'Deleting' },
