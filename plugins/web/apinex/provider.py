...
class ApinexWebSearchProvider(BaseWebSearchProvider):
    ...
    def _instantiate_tier(self, vendor: str, errors: List[str]):
        ...
        _TIERS = {
            "searchx": ("plugins.web.searchx.provider", "SearchxWebSearchProvider", "SEARCHX_API_KEY"),
            "unsearch": ("plugins.web.unsearch.provider", "UnsearchWebSearchProvider", "UNSEARCH_API_KEY"),
