  ...
  assistant: {
    ...
    tool: {
      ...
      titles: {
        ...
        vault_append_note: { done: '已保存到 Vault', pending: '正在保存到 Vault', pendingAction: '正在保存' },
        vault_create_note: { done: '已保存到 Vault', pending: '正在保存到 Vault', pendingAction: '正在保存' },
        vault_delete_note: { done: '已删除 Vault 笔记', pending: '正在删除 Vault 笔记', pendingAction: '正在删除' },
        vault_update_note: { done: '已更新 Vault 笔记', pending: '正在更新 Vault 笔记', pendingAction: '正在更新' },
